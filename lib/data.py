...
def data_from_DB():
    ...
    Car.create("Corvette Stingray Coupe	2022", 2022, 3637.0, 5)
    Car.create("Mustang	2024", 2024, 3579.0, 3)
    ...
    Car.create("Insight	2022", 2022, 3078.0, 1)
    Car.create("GR86 Coupe 2D", 2023, 2868.0, 2)
    Car.create("Avalon	2022", 2022, 3570.0, 2)
    Car.create("Mirai	2023", 2023, 4335.0, 2)
